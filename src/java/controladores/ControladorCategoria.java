    ...
    private void registrar(HttpServletRequest request, HttpServletResponse response) throws IOException{
        try{
            ...
            if(nombre.equals("")){
                ...
                Categoria e = new Categoria(nombre);
                if(ed.obtenerCategoria(e.getNombre())==null){
                    int respuesta = ed.registrar(e);
                    if(respuesta==1){
                    response.sendRedirect("crudcategoria.jsp?msj=Categoria registrada");
                    }else{
                    response.sendRedirect("crudcategoria.jsp?msj=Estado no se pudo registrar");
                    }
                }else{
                    response.sendRedirect("crudcategoria.jsp?msj=Estado ya existe");
                }
            }
           }catch(Exception e){
               response.sendRedirect("crudcategoria.jsp?msj="+e.getMessage());
           }
    }
    ...
    private void eliminar(HttpServletRequest request, HttpServletResponse response) throws IOException{
         try{
            ...
            if(nombre.equals("")||id<1){
                ...
                CategoriaDAO ed = new CategoriaDAO();
                Categoria e = new Categoria(id,nombre);
